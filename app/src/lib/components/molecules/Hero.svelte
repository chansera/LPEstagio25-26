    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-24">
      ...
      <div class="flex flex-col justify-center p-6 md:p-12 lg:p-16 transition-all duration-700 delay-200">
        ...
        <div class="mt-10 flex flex-col sm:flex-row items-start gap-4">
          ...
          <a href="/contato"
             class="bg-aero-100 text-base font-semibold text-aero-600 rounded-xl hover:text-gold-rich transition-colors py-3 px-2 md:text-lg">
      ...
      <!-- Imagem -->
      <div class="relative">
        <div class="hidden lg:block relative rounded-2xl overflow-hidden shadow-2xl group">
          <img
            src={painelImg}
            alt="Painel de componentes aeronáuticos em manutenção"
            class="w-full h-auto object-cover transition-transform duration-500 group-hover:scale-105"
            loading="lazy"
          />
          <div class="absolute inset-0 bg-gradient-to-t from-aero-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        </div>
      </div>
